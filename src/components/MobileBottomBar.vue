<template>
  <div class="mobile-bottom-bar">
    <router-link to="/" class="bottom-bar-item" :class="{ active: currentRoute === '/' }">
    ...
    <router-link to="/favorites" class="bottom-bar-item" :class="{ active: currentRoute === '/favorites' }">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <router-link to="/add-product" class="bottom-bar-item post-button">
      <div class="post-button-circle">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 5V19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M5 12H19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </div>
      <span>{{ t('navigation.postAd') }}</span>
    </router-link>

    <router-link to="/messages" class="bottom-bar-item" :class="{ active: currentRoute === '/messages' }">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <router-link to="/profile" class="bottom-bar-item" :class="{ active: currentRoute === '/profile' }">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
.post-button:hover .post-button-circle {
  background: #20d1c8;
